      ...
      <div className="relative w-full">
        ...
        <div className="flex marquee-track gap-8 md:gap-12 items-center py-6">
          {duplicatedClients.map((client, index) => (
            ...
            >
              <div className="w-[180px] h-[90px] bg-card rounded-2xl border border-border hover:border-accent/30 hover:shadow-xl hover:scale-150 transition-all duration-300 flex items-center justify-center px-5 relative z-0 group-hover:z-20">
                <img
                  src={client.logo}
                  alt={client.name}
                  loading="lazy"
